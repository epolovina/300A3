...
// Maximum total number of nodes (statically allocated) to be shared across all
// lists (You may modify its value for your needs)
#define LIST_MAX_NUM_NODES 100

// General Error Handling:
// Client code is assumed never to call these functions with a NULL List
// pointer, or bad List pointer. If it does, any behaviour is permitted (such as
// crashing). HINT: Use assert(pList != NULL); just to add a nice check, but not
// required.
...
// operations. UPDATED: Changed function pointer type, May 19
